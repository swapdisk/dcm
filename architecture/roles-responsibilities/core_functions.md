...
*   Control Plane
    *   Functions
        ...
        *   Orchestration
            *   Purpose: Coordinate the specific actions needed to faciliate the realization of the Request Payload.
        *   Audit - Combine with Observability? I had these as separate functions for a reason, will document what the reason was when it pops back into my head.
        ...
        *   Rules Engine:
            *   Purpose: Ability to interpret rules and take appropriate actions defined by then based on input data.
        *   IDM / IAM
        ...
        *   Message Bus - Should this be offered as ingress or egress for consumers? If API first is the mentality, then purpose this should only be a means to manage orchestration.
        ...
        *   Drift Remediation / Notification - Does this belong in the Service Provider Role instead?
    ...
    *   Data Sources
        ...
        *   Core Rules
            ...
            *   Caveat: Since this a modular design, it is entirely possible that all service specific rules will be injected via the service provider as to ensure coordination between service providers and relevant security / audit teams.
        *   IDM
        ...
        *   Core Layers
            *   Purpose: Layers for the data payload that are outside the scope of the specific service(s)
                ...
                *   eg; Rack layer
            *   Core Data - Could be combined with Core Layers? Feels like it should be.
                *   Purpose: Provides specific information that is outside the scope of the specific service(s)
                    *   eg; Data Center Name
                    *   eg; Service categories
            *   Business Data / Groups - Could be combined with IDM? Possibly not as defined as below.
                *   Purpose: Provide group information specifically to supply information on business groups for consumers / services.
                    ...
                    *   eg; Product Owner
            *   Discovered Widgets - This may belong in the realm service providers
            ...
            *   Realized Widgets
                ...
                *   Intent / Use: This is meant to be a record of what was realized / provisoned by the service providers, including any additional detail they add during the process. Used for audit, reporting and drift remediation processes.
            *   Log Store
            ...
            *   Service Layer Cache - Should this cache the actual layers or the layer sources? Since there should be no changes outside of a versioned change it should be safe and proper to cache all the version specific layers at the time of service provider services deployment.
...
*   Service Provider
    *   Functions
        ...
        *   Denaturalization
            ...
            *   Intent / Use: Allows DCM to interact with the data created during the realization process via it's natural data model. Allows for drift and audit processes in DCM without need for data translation.
    *   Data Sources
        *   Service Catalog / APIs
            *   Purpose: Details the list of services the service provider provides and the appropriate APIs to call.
            *   Intent / Use: Informs DCM as to what services the provides has and what APIs to use to utilize those services.
        *   Service Rules
